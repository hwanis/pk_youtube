    ...
    <div class="main-content-inner">
        ...
        <!-- #section:basics/content.breadcrumbs -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form name="login_form" action="creator_reg_pr.php"  class="form-horizontal" role="form" enctype="multipart/form-data" >
                        <!-- #section:elements.form -->
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 이 름 </label>
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="ct_name" placeholder="Username" class="col-xs-10 col-sm-5" maxlength="20" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="ct_id" placeholder="Username" class="col-xs-10 col-sm-5"  maxlength="20"  />
                            </div>
                        </div>
