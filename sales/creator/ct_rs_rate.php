<?php
  ...
  //  $branch = $_SESSION[branch];
    ...
    $list =      $obj->getCtSaleRate($page_no, $page_list_no, $where, $branch, 'list');    
    $list_cnt =  $obj->getCtSaleRate($page_no, $page_list_no, $where, $branch, 'cnt');    
...
-->
    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form name="reg_form"  action="daily_sales.php?st_date=<?=$st_date?>&ed_date=<?=$ed_date?>"  class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    <button class="btn btn-message" type="button" name="btnSubmit" onclick="openChild('ct_rs_rate_pop.php', this);">                                                 
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>                         
                            ...
                            <th class="center">시작날짜</th>
                            <th class="center">종료날짜</th>
                            <th class="center">할인율</th>
                            <th class="hidden-480 center">RS</th>                                   
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    ?>
                        <tr>
                            <td class="center">
                                <button class="btn btn-xs btn-info"  onclick="openChild('ct_rs_rate_pop_mod.php?rate_id=<?=$list[$i][rate_id]?>', this);">
                                    <i class="ace-icon fa fa-pencil bigger-160"></i>
                                </button>                             
                            </td>
                            <td class="right"><?=$list[$i][ct_name]?></td>
                             <td  class="center"><?=$list[$i][it_name]?>(<?=$list[$i][sal_pl]==1?'CS':'WEB'?>)</td>
                            <td class="center"><?=$list[$i][sal_from_date]?></td>
                            <td class="center"><?=$list[$i][sal_to_date]?></td>
                            <td class="center"><?=$list[$i][sal_rate]?></td>
                            <td class="center"><?=$list[$i][sal_rs]?></td>                    
                        </tr>
                    <?php 
                        } 
                    ?>											
