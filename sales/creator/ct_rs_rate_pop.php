    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form name="login_form" action="ct_rs_rate_pop_pr.php"  class="form-horizontal" role="form" enctype="multipart/form-data" >
              
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 아이디 </label>
                            <div class="col-sm-3">                                
                                <select class="chosen-select form-control" id="form-field-select-4" name="ct_id" data-placeholder="Choose a Creator..." onChange="javascript:get_item(this.value)">
                                    <?php                                                 
                                ...
                                <tr>                                     
                                    <td>                                                  
                                         <div class="input-group">                                                                                          
                                             <input type="text" id="st_date" name="sal_from_date" class="form-control" readonly/>
                                     ...
                                     <td>                                                  
                                         <div class="input-group">                                                                                          
                                             <input type="text" id="ed_date" name="sal_to_date"  class="form-control" readonly/>
                        ...
                        <div class="space-4"></div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-9"> <input type="text" name="sal_rs" id="spinner2" /></div>
                        </div>
