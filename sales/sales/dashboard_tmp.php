<?php
  ...
  //  echo $basename = basename($_SERVER["PHP_SELF"]);
   ...
   //item id 가져오기
    ...
    switch($_SESSION[s_auth]){            
        case 0: 
            $where = " sal_date BETWEEN '$ed_date' AND '$to_date' ";    //주간
            $where_m = "";  //월간
            $where_r = " "; //실시간 데이터          
            break;
        case 1: 
            ...
            <div class="hr hr-1 hr-dotted"></div>
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="col-sm-6">
                        <div class="widget-box transparent">
                             <h4 class="widget-title lighter"><i class="ace-icon fa fa-star orange"></i> 실시간 판매 현황(현재 시간: <?=date("Y-m-d H:m:s")?>)</h4>
                            <div class="widget-body">
                                <div class="widget-main no-padding">
                                    <table class="table table-bordered table-striped">
                                        <thead class="thin-border-bottom">
