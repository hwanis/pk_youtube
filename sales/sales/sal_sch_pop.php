    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form name="login_form" action="sal_sch_pop_pr.php"  class="form-horizontal" role="form" enctype="multipart/form-data" >
                        <input type="hidden" name="sal_no" value="<?=$_REQUEST[sal_no]?>" >
                        <!-- #section:elements.form -->
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 크리에이터  </label>
                            <div class="col-sm-5">
                               <select class="chosen-select form-control" id="form-field-select-4" name="ct_id" data-placeholder="크리에이터를 선택 해주세요..." >
                                    <?php                                                 
                                        for($i=0;$i<count($ct_dd_list);$i++){
                                    ?>
                                        <option value=""> </option>
                                    <?php
                                        if($get_sch[ct_id] == $ct_dd_list[$i][ct_id]){
                                    ?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 제품 </label>
                            <div class="col-sm-5">
                                <select class="chosen-select form-control" id="it_id" name="it_id" data-placeholder="제품을 선택해 주세요..." onChange="javascript:set_item_name(this.form)">
                                    <?php                                                 
                                        for($i=0;$i<count($ct_it_list);$i++){
                                    ?>
                                        <option value=""> </option>
                                    <?php
                                        if($get_sch[it_id] == $ct_it_list[$i][it_id]){
                                    ?>
                                        <option value="<?=$ct_it_list[$i][it_id]?>" selected><?=$ct_it_list[$i][it_name]?></option>                                                           
                                    <?php
                                        }else{
                                    ?>
                                        <option value="<?=$ct_it_list[$i][it_id]?>" ><?=$ct_it_list[$i][it_name]?></option>        
                                    <?php                                                        
                                        }
                                    }
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                               <select class="chosen-select form-control" id="form-field-select-4" name="it_class_opt" data-placeholder="Choose a Creator...">                                      
                        ...
                        <div class="space-4"></div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="form-field-1" name="act_url" placeholder="URL을 입력 하세요" class="col-xs-10 col-sm-12"  maxlength="50"  value="<?=$get_sch[act_url]?>"  />
                            </div>                           
                        </div>
                       
                        <div class="space-4"></div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 시작 일자 </label>
                            
                           <div class="input-group col-sm-4" style="left:10px">
                               <input id="date-timepicker1"  type="text" name="st_date" class="form-control" dateFormat="yy-mm-dd h:m:s" value="<?=$get_sch[st_date]?>" />
                        ...
                        <div class="space-4"></div>
                        <div class="form-group">
                             <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 종료 일자 </label>
                            
                           <div class="input-group col-sm-4" style="left:10px">
                               <input id="date-timepicker2" type="text" name="ed_date" class="form-control"  value="<?=$get_sch[ed_date]?>"  />
                                <span class="input-group-addon">
                                        <i class="fa fa-clock-o bigger-110"></i>
                                </span>
                            </div>
    ...
    <div class="hr hr32 hr-dotted"></div>
		...
		<!-- basic scripts -->
            ...
            //    var str_m_pass = fn_str_trim(form.m_pass.value);
                ...
                var str_class_opt = form.it_class_opt.value;
                var str_act_url = form.act_url.value;
                var str_st_date = form.st_date.value;
                var str_ed_date = form.ed_date.value;
                
                if (str_ct_id === ''){
                    alert("크리에이터를 선택 해주세요.");
                    form.ct_id .focus();
                    return;
                }
