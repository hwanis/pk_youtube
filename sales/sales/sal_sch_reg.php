                     ...
                     <form name="login_form" action="sal_sch_reg_pr.php"  class="form-horizontal" role="form" enctype="multipart/form-data" >
                        ...
                        <div class="space-4"></div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="act_url" placeholder="URL을 입력 하세요" class="col-xs-10 col-sm-9"  maxlength="50"  />
                            </div>                           
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="input-group col-sm-3" style="left:10px">
