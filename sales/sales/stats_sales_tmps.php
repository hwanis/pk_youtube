<?php
  ...
  //  echo $basename = basename($_SERVER["PHP_SELF"]);
    ...
    $sin_list = $obj_st ->getStatsDailySales($ct_id = 'pk_tlsdmlgkstn', $it_id, $st_date, $ed_date);
    $pro_list = $obj_st ->getStatsDailySales($ct_id = 'pk_vmfhdusdn', 2048543501, $st_date, $ed_date);
    $kevin_list = $obj_st ->getStatsDailySales($ct_id = 'pk_kevin', 2048543502, $st_date, $ed_date);
    //    $sin_list = $obj_st ->getStatsDailySales($ct_id = 'pk_tlsdmlgkstn', $it_id, $st_date, $ed_date);
//    $sin_list = $obj_st ->getStatsDailySales($ct_id = 'pk_tlsdmlgkstn', $it_id, $st_date, $ed_date);

    //total
    $tot_list = $obj_st->getStatsTotSales($st_date, $ed_date);
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div id="tot"  class="tab-pane fade in active">                                                       
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>   
                                                ...
                                                <td style="text-align: right"><?=number_format($sin_list[$i][sun_price]+$sin_list[$i][org_price]+$sin_list[$i][ji_price])?></td>
                                                <td style="text-align: right"><?=number_format($sin_list[$i][sun_qty]+$sin_list[$i][org_qty]+$sin_list[$i][ji_qty])?></td>
                           ...
                           <div style="width: 100%; height: 600px; overflow: auto">
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>   
                                                <td style="text-align: right"><?=$pro_list[$i][sal_date]?></td>                                                 
                                                <td style="text-align: right"><?=number_format($pro_list[$i][tot_price])?></td>
                                                <td style="text-align: right"><?=number_format($pro_list[$i][tot_qty])?></td>
                                                <td style="text-align: right"><?=number_format($pro_list[$i][tot_price])?></td>
                                                <td style="text-align: right"><?=number_format($pro_list[$i][tot_qty])?></td>
                          ...
                          <div id="pro"  class="tab-pane">                                                       
                           ...
                           <div style="width: 100%; height: 600px; overflow: auto">
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th class="center" rowspan="2">주문일pro</th>
                                            <th class="center"  colspan="2">합계</th>
                                            <th class="center"  colspan="2">구전녹용(10EA)</th>                                                                    
                                        </tr>
                                        <tr>                                              
                                            <th class="center" >수량</th>
                                            <th class="center" >총매출</th>
                          ...
                          <div id="kevin"  class="tab-pane">                                                       
                            <div class="table-header">&nbsp;</div>                                            
                           <div style="width: 100%; height: 600px; overflow: auto">
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th class="center" rowspan="2">주문일kevin</th>
                                            <th class="center"  colspan="2">합계</th>
                                            <th class="center"  colspan="2">구전녹용(10EA)</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            for($i=0;$i<count($kevin_list);$i++){
                                        ?>
                                            <tr>   
                                                <td style="text-align: right"><?=$kevin_list[$i][sal_date]?></td>                                                 
                                                <td style="text-align: right"><?=number_format($kevin_list[$i][tot_price])?></td>
                                                <td style="text-align: right"><?=number_format($kevin_list[$i][tot_qty])?></td>
                                                <td style="text-align: right"><?=number_format($kevin_list[$i][tot_price])?></td>
                                                <td style="text-align: right"><?=number_format($kevin_list[$i][tot_qty])?></td>
                          ...
                          <!-- 김새해 -->
                          <!--
                          <div id="kim"  class="tab-pane">                                                       
                            <div class="table-header">&nbsp;</div>                                            
                           <div style="width: 100%; height: 600px; overflow: auto">
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th class="center" rowspan="2">주문일kim</th>
                                            <th class="center"  colspan="2">합계</th>
                                            <th class="center"  colspan="2">구전녹용(10EA)</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr >   
                                                <td style="text-align: right">2019-12-31</td>                                                 
