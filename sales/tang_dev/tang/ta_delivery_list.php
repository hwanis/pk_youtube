<?php
 ...
 //   echo 'hsid :'.$_REQUEST[hsid].'<br>';
    ...
    if($_REQUEST[tag] == 'del'){    
        ...
        $del = $obj->delTangList($get_post, $_REQUEST[hsid]);       
    }
  
    //탕 전송 데이터 리스트       
    $list = $obj->getTangList($st_date, $task = "list", $branch, $ta_status = $_REQUEST[ta_status]);    
 
    //택배사별 개수
    $none_cnt = $obj->getTangDeliveryCount($st_date, 0, $branch, $ta_status = $_REQUEST[ta_status]);    
    $cj_cnt = $obj->getTangDeliveryCount($st_date, 11, $branch, $ta_status = $_REQUEST[ta_status]);
    $woo_cnt = $obj->getTangDeliveryCount($st_date, 12, $branch, $ta_status = $_REQUEST[ta_status]);
    $ems_cnt = $obj->getTangDeliveryCount($st_date, 13, $branch, $ta_status = $_REQUEST[ta_status]);
...
?>
    ...
    function openChild(url, field) {
        ...
        window.open(url, 'pop', 'status=no, scroll=yes height=700, width=1400, left='+ popupX + ', top='+ popupY + ', screenX='+ popupX + ', screenY= '+ popupY);

    }
    
    function openHiddenChild(url, hsid) {
        ...
        window.location.href='ta_delivery_list.php?st_date=&tag=del&hsid='+hsid;
    }    
    ...
    function fncUpdateDelivery(delivery, st_date, branch){
       ...
       // alert(branch);
        ...
        url = "ta_pop_update_delivery.php?delivery="+deli_very+"&st_date="+today+"&branch="+branch+"&tag=l";        
...
<div class="main-content">
    <div class="main-content-inner">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="widget-box">                            
                            <form name="reg_form"  action="ta_delivery_list.php"  class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            ...
                                            <th>택배</th>
                                            <th>진료날자</th>
                                            <th>메모</th><th>연락처1</th><th>연락처2</th><th>주소</th>                                            
                                            <th>약처방</th><th>팩수</th>
                                           <!-- <th>택배발송일</th> -->
                                            <th>지점</th>
                                        ...
                                        ?>     
                                            ...
                                            ?>
                                             <tr>
                                                ...
                                                <td class="center">                                              
                                                    <button class="btn btn-white btn-info btn-bold"  onclick="openChild('ta_delivery_popn.php?hsid=<?=$list[$i][hsid]?>', this);" >Edit</button>   
                                                <!--    <button class="btn btn-white btn-info btn-bold"  onclick="openHiddenChild('ta_delivery_list.php', <?=$list[$i][hsid]?>)" >Del</button> -->
                                                                ...
                                                                <td>                                                                    
                                                                    <?php
                                                                       ...
                                                                       // $get_post[doc_date] = $req_st_date;   
                                                                        $obj = new class_shipTa();
                                                                        $update = $obj->updateBatchDelivery($get_post, $req_st_date, $req_branch);    
     ...
     <div id="ta_tang">
                    <iframe  src="if_tang.php?st_date=<?=$st_date?>" name="i_ta_tang" width="0" height="0" border='0'></iframe>                                
                </div>
    <?php
