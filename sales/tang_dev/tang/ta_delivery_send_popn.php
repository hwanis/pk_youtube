<?php
    ...
    $view = $obj->getSendOrderView($_REQUEST[od_number]);
   // $view[prepare_date];
           
    // tang list  
  //  $view = $obj->getTangView($_REQUEST[hsid], $_REQUEST[dr_id]);     
    $view_file = $obj_curd->curdList($table = 'attatch_file', $where = ' od_number ='.$_REQUEST[od_number]);
    // 약처방 정보    
    $prescription = $obj_curd->curdRecord($table = 'prescription', $where = ' od_number ='.$_REQUEST[od_number]);
    
    switch($prescription[pre_name]){
          
          case '편강탕': $pre_name_pg = $prescription[packs_quantity]; break;
          case '보중환': $pre_name_bo = $prescription[packs_quantity]; break;
          case '편강환': $pre_name_h30 = $prescription[packs_quantity]; break;
          case '편강탕 가미': $pre_name_ga = $prescription[packs_quantity]; break;
          default : $pre_name_ch = $prescription[packs_quantity]; break;
      }
    
    // 상세 처방 내용    
    $field = " a.od_number od_number, a.st_no st_no, packs_quantity, b.st_name st_name ";
    $pre_detail = $obj_curd->curdJoinList($field, $table = 'prescription_detail a INNER JOIN stuff_inventory b ON a.st_no = b.st_no', $where = 'od_number ='.$_REQUEST[od_number]);
    ...
    if($_REQUEST[tag]){
     ...
     //상품 발송일 가져오기
    $prepare_date = $obj_curd->curdRecord($table = 'sch_delivery', $where = "d_packing = '$view[treat_date]'");
    
     //약재명 가져오기
    //getStuffInventory
    $obj_stuff = new class_shipCommon();    
    $stuff_list = $obj_stuff->getStuffInventory();
    
    /*
    진료일 - 주문(d day)        - 101, 102
    패킹일 - 상품 준비중(d+1) - 103
    발송일 - 상품 발송(d+2)   - 104
    완료일 - 발송 완료(d+3)   - 201
    취소 -
    ...
    <body class="no-skin" onload="init('<?=$view[tname]?>');">
            ...
            <div class="main-content">
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main padding-1">     
                                                  ...
                                                  <div class="col-sm-12 col-sm-offset-0" style="padding-bottom: 10px" >기본 정보</div>
                                                    <div>     
                                                        <form name="reg_form"  action="ta_delivery_send_popn_pr.php"  class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <input type="hidden" name="br_code" value="<?=$view[br_code]?>">                                                             
                                                            <input type="hidden" name="cs_name" value="<?=$view[cs_name]?>">    
                                                            <input type="hidden" name="treat_date" value="<?=$view[treat_date]?>"> 
                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            $split_tel = explode('-', $view[c_phone]);
                                                                        ?>
                                                                 ...
                                                                 <tr>
                                                                     <td>주소</td>
                                                                     <td class="hidden-xs" colspan="3"> <input type="text" style="width:100%" name="address" value="<?=$view[address]?>"></td>
                                                                </tr>
                                                                ...
                                                                <tr>    
                                                                    <td>처방일</td>                                                                   
                                                                    <td><?=$view[treat_date]?></td>
                                                                    <td>발송일</td>
                                                                    <td>
                                                                        <div class="input-group">
                                                                            <input class="form-control date-picker" id="reserve_date_1" type="text" name="reserve_date_1" data-date-format="yyyy-mm-dd" value="<?=$view[delivery_date]?>" readonly />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        ...
                                                                        ?>
                                                                            [삭제]<a href="ta_file_download.php?tag=u&file_id=<?=$view_file[$i][file_id]?>"><?=$view_file[$i][file_o_name]?></a><br>                                                                        
                                                                        <?php
                                                                            }                                                                        
                                                                        ?>
                                                                    </td>
                ...
                <!-- PAGE CONTENT ENDS -->
                                                ...
                                                <div class="widget-main padding-1">                                                         
                                                    ...
                                                    <div>                                                       
                                                        <table class="table table-striped table-bordered">
                                                            <tbody>                                                                                                                             
                                                                <tr>
                                                                    <td>약처방( 처방명:  <?=$prescription[pre_name]?> / 팩수: <?=$prescription[tot_pakcs]?>)
                                                                        <!--<input type="Button" value="추가" onclick="addForm()">
                                                                        <input type="Button" value="삭제" onclick="delForm()">
                                                                        <input type="hidden" name="count" value="0" >    
                                                                        -->
                                                                        총첩수 <?=$prescription[take_date]?> / <input type="hidden" name="take_date" value="<?=$prescription[take_date]?>">       
                                                                        총량  <?=$prescription[packs_quantity]?>g  / <input type="hidden" name="packs_quantity" value="<?=$prescription[packs_quantity]?>">       
                                                                        첩당량 총량   <input type="hidden" name="tot_packs" value="<?=$pres_array[tot_pakcs]?>">    
                                                                        <input type="hidden" name="pre_name" value="<?=$prescription[pre_name]?>"> 
                                                                        <input type="hidden" class="col-xs-5" name="tot_pakcs" value="<?=$prescription[tot_pakcs]?>">
                                                                        <!--<input type="Button" value="추가" onclick="addForm()">
                                                                        <input type="Button" value="삭제" onclick="delForm()">
                                                                        <input type="hidden" name="count" value="0" >                                                                    -->
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="5">                                                                       
                                                                        <table  class="table table-striped table-bordered" >                                                                         
                                                                            ...
                                                                            <?php
                                                                             //   $stuff_count = 0;
                                                                                for($i=0;$i<count($pre_detail);$i++){                                                                                    
                                                                             ?>
                                                                         
                                                                                <td style="width:25%">
                                                                                  
                                                                                   <select class="chosen-select form-control" id="st_no" style="display: none" name="st_no_<?=$i?>" data-placeholder="제품을 선택해 주세요..." >
                                                                                        <?php                                                 
                                                                                        for($j=0;$j<count($stuff_list);$j++){                                                                                     
                                                                                            if($pre_detail[$i][st_name] == $stuff_list[$j][st_name]){
                                                                                        ?>
                                                                                            <option value="<?=$pre_detail[$i][st_no]?>" selected><?=$pre_detail[$i][st_name]?></option>                                                           
                                                                                        <?php
                                                                                            }else{
                                                                                        ?>
                                                                                            <option value="<?=$pre_detail[$i][st_no]?>" ><?=$pre_detail[$i][st_name]?></option>        
                                                                                        <?php                                                        
                                                                                            }
                                                                                        }
                                                                                        ?>
                                                                            ...
                                                                            ?>
                                                                                 ...
                                                                                 -->
                                                                               <!-- 
                                                                                <td style="width:25%"> <input type="text" name="tot_packs_<?=$i?>" style="width:100%" value="<?=$pres_array[J_G.$i]?>"></td>
                                                        ...
                                                        <div style="margin-bottom:10px">상세처방</div>
                                                            <table  class="table table-striped table-bordered" >  
                                                                <tr>
                                                                    <td style="text-align: center">약재</td><td style="text-align: center">첩당량</td>
                                                                    <td style="text-align: center">약재</td><td style="text-align: center">첩당량</td>
                                                                    <td style="text-align: center">약재</td><td style="text-align: center">첩당량</td>
                                                                </tr>
                                                                <?php
                                                                ...
                                                                <tr>
                                                                    <td style="width: 16%">                                                                     
                                                                        ...
                                                                        <input type="text" name="st_name_<?=$i?>" style="width:100%;text-align: center" value="<?=$pre_detail[$i][st_name]?>" readonly="true">
                                                                         <input type="hidden" name="st_no_<?=$i?>" value="<?=$pre_detail[$i][st_no]?>">
                                                                    </td>
                                                                   <td style="width: 16%">                 
                                                                        <input type="text" name="packs_quantity_<?=$i?>" style="width:100%;text-align: center" value="<?=$pre_detail[$i][packs_quantity]?>"  readonly="true">
                                                                    </td>
                                                                    <?php $i = $i+1; ?>
                                                                    <td style="width: 16%">                                                                     
                        ...
                        <div class="col-sm-12 col-sm-offset-5">
                            <button class="btn btn-info" type="button" name="btnSubmit" value="i" onclick="javascript:SubmitXls(this.form)">
                            ...
                            <button class="btn btn-danger" type="button" name="btnTrans" value="i"" >
                                <i class="ace-icon fa fa-check bigger-110"></i>
                                <font size="2.5pt"> 추 &nbsp;&nbsp;가 &nbsp;&nbsp;</font>
                            </button>
                ...
                <script>                 
                    ...
                    function SubmitXls(form) {
                      ...
                      //form.btnSubmit.action = "ta_delivery_popn_pr.php?tag=u";
                        form.action = "ta_delivery_send_popn_pr.php?tag=u";
                        form.submit();
		...
		<script type="text/javascript">
                jQuery(function($) {
                    ...
                    //spinner
                    $('#spinner1').ace_spinner({value:0,min:0,max:999,step:5, on_sides: true, icon_up:'ace-icon fa fa-plus small-110', icon_down:'ace-icon fa fa-minus bigger-110', btn_up_class:'btn-success' , btn_down_class:'btn-danger'});
